		...
		<div class="row">
			<div class="col-md-12">
				<div class="invoice-wrapper">
					<div class="intro">
						Witaj <strong>{{ $zamowienie->zamowienia->name. ' ' .$zamowienie->zamowienia->surname}}</strong>, 
						<br>
						Paragon wystawiony na kwote  <strong>{{ $zamowienie->ZamowienieKoszt.' zł' }}</strong> za dokonane zakupy
					</div>
					...
					<div class="payment-info">
						<div class="row">
							...
							<div class="col-sm-6 text-right">
								...
								<strong>{{ $zamowienie->created_at }}</strong>
							</div>
						</div>
					</div>
					...
					<div class="payment-details">
						<div class="row">
							<div class="col-sm-6">
								<span>Klient</span>
								<strong>
                                {{ $zamowienie->zamowienia->name. ' ' .$zamowienie->zamowienia->surname}}
								</strong>
								<p>
                                {{ $zamowienie->zamowienia->adress}}<br>
									<a href="mailto: {{ $zamowienie->zamowienia->email}}">
                                    {{ $zamowienie->zamowienia->email}}<br>
									</a>
								</p>
							</div>
							<div class="col-sm-6 text-right">
					...
					<div class="line-items">
						...
						<div class="total text-right">
							...
							<div class="field">
								Cena łączna <span>{{ $zamowienie->ZamowienieKoszt.' zł' }}</span>
							</div>
							<div class="field">
							...
							<div class="field grand-total">
								Total <span>{{ $zamowienie->ZamowienieKoszt.' zł' }}</span>
							</div>
						</div>
