        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form method="POST" action="{{ route('uzytkownik.store') }}" id="Uzytkownicy-form" class="user">
                        @csrf

                        <div class="form-group">
                            <input type="text"
                                class="form-control form-control-user @error('name') is-invalid @enderror" name="name"
                                value="{{ old('name') }}" required placeholder="Imie">
                        ...
                        <div class="form-group">
                            <input type="text"
                                ...
                                name="surname" value="{{ old('surname') }}" required placeholder="Nazwisko">
                        ...
                        <div class="form-group">
                            <input type="number"
                                ...
                                value="{{ old('phone') }}" required placeholder="Telefon">
                        ...
                        <div class="form-group">
                            <input type="text"
                                class="form-control form-control-user @error('adress') is-invalid @enderror"
                                name="adress" value="{{ old('adress') }}" required placeholder="Adress">
...
{!! JsValidator::formRequest('App\Http\Requests\Uzytkownicy\StoreUzytkownicyRequest', '#Uzytkownicy-form'); !!}
