...
<div class="w3l_banner_nav_right">
    ...
    <div class="container" style="background-color:white;">
        <div class="row p-2 ">
            <div class="col-lg-12">
                <div class="well lead text-center text-success"><strong>Witaj <b>{{ $uzytkownik->name }}</b>. Sprawdź
                        swoje dane kontaktowe. Jeżeli wszystko się zgadza przejdź dalej.</strong></div>
                <br>
                <br>
            </div>
            <div class="col-lg-12">
