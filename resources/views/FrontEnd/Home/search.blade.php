@extends('FrontEnd.FrontEndSzablon5')
    ...
    <div class="col-lg-12">
        ...
        <div class="col-md-12 ">
            <div class="row p-4">
                ...
                <section class="mb-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><span class="mr-1"><strong>{{ $product->Cena }}zł /
                                        {{$product->JednostkaMiary}}</strong></span></p>
                ...
                <h4>
                    <p class="nieznaleziono p-4">Nie znaleziono produktów spełniających twoje kryteria!</p>
                </h4>
