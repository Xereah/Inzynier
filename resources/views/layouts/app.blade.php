...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav navbar-dark bg-dark sidebar sidebar-dark accordion" style="height:auto;"
            id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseGospodarstwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-tractor"></i>
                    <span>Dane Gospodarstwa</span>
                </a>
                <div id="collapseGospodarstwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <ul class="navbar-nav ml-auto">
                                ...
                                <form class="form-inline mr-auto w-100 navbar-search">
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small"
                                            placeholder="Szukaj..." aria-label="Search" aria-describedby="basic-addon2">
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="button">
                                                <i class="fas fa-search fa-sm"></i>
                                            </button>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                @if($produktystanilosc ==0)
                                <span class="dropdown-item dropdown-header">1 Powiadomienie</span>
                                @else
                                <span class="dropdown-item dropdown-header">2 Powiadomienia</span>
                                @endif
